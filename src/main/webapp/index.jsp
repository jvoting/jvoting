						...
						<div class="login-container">
							...
							<div class="login-container-content">
								<ul class="nav nav-tabs nav-justified">
									<li class="active link-one"><a
										href="login.jsp#login-block" data-toggle="tab"><i
											class="fa fa-sign-in"></i>Se connecter</a></li>
									<li class="link-two"><a href="login.jsp#register-block"
										data-toggle="tab"><i class="fa fa-pencil"></i>S'inscrire</a></li>
									<li class="link-three"><a href="login.jsp#contact-block"
										data-toggle="tab"><i class="fa fa-envelope"></i>Contact</a></li>
								</ul>
									...
									<div class="tab-pane active fade in" id="login-block">
										...
										<div class="login-block-form">
											...
											<form class="form" role="form" method="post"
												action="/jvoting/Authentification">
												<!-- Form Group -->
												...
												<div class="form-group">
													<label class="control-label">Mot de passe</label> <input
														name="mdp" type="password" class="form-control"
												...
												<div class="form-group">
													<a href="index.jsp" class="black">Mot de passe oublié ?</a>
												</div>
											</form>
										</div>
									</div>
											...
											<form class="form" role="form">
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="comments" rows="5"
														placeholder="Entrer Commentaire"></textarea>
												</div>
												<div class="form-group">
													<!-- Buton -->
													<button type="submit" class="btn btn-primary">Soumettre</button>
								...
								<div class="col-sm-4 col-md-4">
									<ul class="bottom-footer-menu for-social">
										...
										<li><a href="index.html#"><i
												class="ri ri-google-plus" data-toggle="tooltip"
												data-placement="top" title="google plus"></i></a></li>
										<li><a href="index.html#"><i
												class="ri ri-youtube-play" data-toggle="tooltip"
