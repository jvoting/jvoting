...
<%@ page import="servlet.ListProfilVote"%>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-10 col-md-8 col-sm-offset-1 col-md-offset-2">
							...
							<%
								ListProfilVote s = new ListProfilVote(); //not recommended.Pass this object from servlet
								ArrayList<String> list = s.print();
							%>

							<table>
								<c:forEach items="<%=list%>" var="item">
									<tr>
										<a href="/jvoting/ProfilVoteDetail?nameProfilVote=${item}"
											name="ProfilVoteDetail"><c:out value="${item}" /> <br />
											<br /></a>
									</tr>
								</c:forEach>
							</table>

							<a href="accueil.jsp" class="btn btn-primary mt-15">Retour à
								la page d'accueil</a>
