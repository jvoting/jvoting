										...
										<div class="row gap-20">
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group ">
													<label>Profile</label> <input type="file" name="file">
													<span class="font12 font-italic">** Choisiez votre
														profile depuis votre ordinateur</span>
												</div>
											...
											<div class="col-sm-12 col-md-8">
												...
												<div class="form-group">
													<label>Nom de fichiere:</label> <input type="text"
