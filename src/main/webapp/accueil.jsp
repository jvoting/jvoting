...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<!-- start hero-header -->
			<div class="hero"
				style="background-image: url('images/hero-header/index-banner.png');">
				<div class="container">
				...
				<div class="container frontend">
					...
					<div class="block process-block">
						...
						<div class="row text-center">
							<ol class="process">
								<li class="col-md-3 col-sm-6 col-xs-6"><i
									class="fa fa-cutlery" aria-hidden="true"></i>
									<h4>Plateforme logicielle</h4></li>
								<li class="col-md-3 col-sm-6 col-xs-6"><i class="fa fa-car"></i>
									<h4>Pour visualiser des données des élections</h4></li>
								<li class="col-md-3 col-sm-6 col-xs-6"><i
									class="fa fa-beer"></i>
									<h4>De les manipuler</h4></li>
								<li class="col-md-3 col-sm-6 col-xs-6"><i
									class="fa fa-thumbs-o-up"></i>
									<h4>Et de tester des méthodes</h4></li>
							</ol>
						</div>
