...
<table>
  <c:forEach items="<%=list%>"  var="item">
    <tr>
      <a href="/jvoting/ProfilVoteDetail?nameProfilVote=${item}"  name="ProfilVoteDetail"><c:out value="${item}" /> <br /> <br /></a> 
    </tr>
  </c:forEach>
</table>
							
							<a href="accueil.jsp" class="btn btn-primary mt-15">Retour à la page d'accueil</a>
