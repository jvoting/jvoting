						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form action="AddProfilVoteURLServlet" method="post" enctype="multipart/form-data" class="post-form-wrapper">
												...
												<div class="col-sm-12 col-md-8">
													...
													<div class="form-group">
														<label>URL de fichier:</label>
														<input type="text" name="profilVoteUrl" class="form-control" value="URL de fichier">
													</div>
